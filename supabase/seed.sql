...
create table if not exists profiles (
  ...
  role text not null,
  qie_pass_verified boolean default false
);
...
-- Demo profiles
insert into profiles (address, display_name, role, qie_pass_verified) values
  ('0x70997970c51812dc3a010c7d01b50e0d17dc79c8', 'Maya Chen', 'Freelance Designer', true),
  ('0x3c44cdddb6a900fa2b585dd299e03d12fa4293bc', 'Dr. Alex Rivera', 'AI Researcher', true),
  ('0x90f79bf6eb2c4f870365e785982e1f101e93b906', 'ShopWave Store', 'Small Online Merchant', false)
